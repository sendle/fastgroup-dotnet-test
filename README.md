...
The problem we've chosen is a pricing system, since we have one of those at FAST Group.
...
you a flavour for some of the problems you might work on at FAST Group.

This exercise consists of one failing top level integration spec. If you run `dotnet test` you should
